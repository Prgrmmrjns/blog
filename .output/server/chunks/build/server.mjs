import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, inject, getCurrentInstance, defineComponent, shallowRef, h, resolveComponent, computed, defineAsyncComponent, useSSRContext, ref, Suspense, Fragment, createApp, mergeProps, withCtx, createTextVNode, toDisplayString, unref, provide, shallowReactive, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, isRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { e as createError$1, k as parseQuery, l as getContext, m as hasProtocol, j as joinURL, n as parseURL, o as encodePath, q as decodePath, w as withQuery, r as isScriptProtocol, s as withTrailingSlash, t as withoutTrailingSlash, v as sanitizeStatusCode, $ as $fetch, x as baseURL, y as createHooks, z as executeAsync, A as getHeader, B as setCookie, C as defu } from '../nitro/nitro.mjs';
...
const matcher = /* @__PURE__ */ (() => {
  ...
  return (m, p) => {
    ...
    if (p === "/__nuxt_content/posts/sql_dump.txt") {
      r.unshift({ data: $0 });
    }
    let s = p.split("/");
    s.length - 1;
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "fixed left-0 right-0 top-0 z-50 border-b border-gray-200 bg-[#f5f3eb]/90 backdrop-blur-md transition-colors dark:border-white/5 dark:bg-[#0e0e0e]/80" }, _attrs))}><div class="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "text-lg font-bold text-gray-900 transition-colors hover:text-teal dark:text-cream dark:hover:text-mint"
      }, {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      script: [
        {
          innerHTML: `(function(){var t=localStorage.getItem('theme');var d=!(t==='light'||(t!=='dark'&&!window.matchMedia('(prefers-color-scheme: dark)').matches));document.documentElement.classList.toggle('dark',d);})();`,
          tagPosition: "head"
        }
      ]
    });
...
export { __nuxt_component_0$1 as _, useRuntimeConfig as a, useNuxtApp as b, useRoute as c, createError as d, entry_default as default, asyncDataDefaults as e, tryUseNuxtApp as t, useHead as u };
