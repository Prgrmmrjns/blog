import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, getCookie, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/jwolber/Documents/blog/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import _RemarkEmoji from 'file:///Users/jwolber/Documents/blog/node_modules/remark-emoji/index.js';
import { createStorage, prefixStorage } from 'file:///Users/jwolber/Documents/blog/node_modules/unstorage/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/jwolber/Documents/blog/node_modules/ufo/dist/index.mjs';
import { hash } from 'file:///Users/jwolber/Documents/blog/node_modules/ohash/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/jwolber/Documents/blog/node_modules/defu/dist/defu.mjs';
import { basename, extname } from 'file:///Users/jwolber/Documents/blog/node_modules/pathe/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///Users/jwolber/Documents/blog/node_modules/scule/dist/index.mjs';
import { unified } from 'file:///Users/jwolber/Documents/blog/node_modules/unified/index.js';
import { toString as toString$1 } from 'file:///Users/jwolber/Documents/blog/node_modules/mdast-util-to-string/index.js';
import { postprocess, preprocess } from 'file:///Users/jwolber/Documents/blog/node_modules/micromark/dev/index.js';
import { stringifyPosition } from 'file:///Users/jwolber/Documents/blog/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///Users/jwolber/Documents/blog/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/jwolber/Documents/blog/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///Users/jwolber/Documents/blog/node_modules/micromark-util-resolve-all/index.js';
import { normalizeUri } from 'file:///Users/jwolber/Documents/blog/node_modules/micromark-util-sanitize-uri/dev/index.js';
import remarkParse from 'file:///Users/jwolber/Documents/blog/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///Users/jwolber/Documents/blog/node_modules/remark-rehype/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///Users/jwolber/Documents/blog/node_modules/remark-mdc/dist/index.mjs';
import remarkGFM from 'file:///Users/jwolber/Documents/blog/node_modules/remark-gfm/index.js';
import rehypeExternalLinks from 'file:///Users/jwolber/Documents/blog/node_modules/rehype-external-links/index.js';
import rehypeSortAttributeValues from 'file:///Users/jwolber/Documents/blog/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///Users/jwolber/Documents/blog/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///Users/jwolber/Documents/blog/node_modules/rehype-raw/index.js';
import { detab } from 'file:///Users/jwolber/Documents/blog/node_modules/detab/index.js';
import { toString } from 'file:///Users/jwolber/Documents/blog/node_modules/hast-util-to-string/index.js';
import Slugger from 'file:///Users/jwolber/Documents/blog/node_modules/github-slugger/index.js';
import destr, { destr as destr$1 } from 'file:///Users/jwolber/Documents/blog/node_modules/destr/dist/index.mjs';
import slugify from 'file:///Users/jwolber/Documents/blog/node_modules/slugify/slugify.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/jwolber/Documents/blog/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/jwolber/Documents/blog/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/jwolber/Documents/blog/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/jwolber/Documents/blog/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/jwolber/Documents/blog/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/jwolber/Documents/blog/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/jwolber/Documents/blog/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/jwolber/Documents/blog/node_modules/klona/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jwolber/Documents/blog/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jwolber/Documents/blog/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/jwolber/Documents/blog/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/jwolber/Documents/blog/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/jwolber/Documents/blog/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/jwolber/Documents/blog/node_modules/vue/index.mjs';
import { getIcons } from 'file:///Users/jwolber/Documents/blog/node_modules/@iconify/utils/lib/index.mjs';
import { collections } from 'file:///Users/jwolber/Documents/blog/.nuxt/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/jwolber/Documents/blog/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/jwolber/Documents/blog/node_modules/@unhead/shared/dist/index.mjs';
...
const _DsLdshZd1d = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script$1}<\/script>`);
  });
});

const rootDir = "/Users/jwolber/Documents/blog";
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    ...
    "supabase": {
      "url": "https://cbevnbfucjqqzzhiymjx.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImNiZXZuYmZ1Y2pxcXp6aGl5bWp4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NDU5OTg0NjgsImV4cCI6MTk2MTU3NDQ2OH0.dEFBHPwSHcznThoO56KnHi2AcfJ7_2TvCAnvNt2027g",
      "redirect": false,
      "redirectOptions": {
        "login": "",
        "callback": "",
...
const serverAssets = [{"baseName":"server","dir":"/Users/jwolber/Documents/blog/server/assets"}];
...
storage$1.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/Users/jwolber/Documents/blog/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jwolber/Documents/blog/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jwolber/Documents/blog","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jwolber/Documents/blog/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jwolber/Documents/blog/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jwolber/Documents/blog/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jwolber/Documents/blog/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _AsAM1DQEGN = defineNitroPlugin(async (nitro) => {
...
const _Lq6qoHifQS = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _r9lcYn = defineCachedEventHandler(async (event) => {
...
const _lUyrZr = defineEventHandler(async (event) => {
...
const _RD8kPV = defineEventHandler(async (event) => {
...
const _FzlcRh = defineEventHandler(async (event) => {
  const { getContentQuery } = await Promise.resolve().then(function () { return query; });
  const { cacheStorage, serverQueryContent } = await Promise.resolve().then(function () { return storage; });
...
const _lazy_TgTDOQ = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_TgTDOQ, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _r9lcYn, lazy: false, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _lUyrZr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _lUyrZr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _lUyrZr, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _RD8kPV, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _FzlcRh, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _FzlcRh, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _FzlcRh, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_TgTDOQ, lazy: true, middleware: false, method: undefined }
];
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///Users/jwolber/Documents/blog/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const getClientManifest = () => import('file:///Users/jwolber/Documents/blog/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/jwolber/Documents/blog/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
