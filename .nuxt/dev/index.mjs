...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, getRouterParam, setHeader, getResponseStatus, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatusText } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/unhead/dist/utils.mjs';
import { isAbsolute } from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/@nuxt/content/node_modules/pathe/dist/index.mjs';
import localAdapter from 'file:///Users/jwolber/Documents/recipes_blog/node_modules/db0/dist/connectors/better-sqlite3.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/jwolber/Documents/recipes_blog/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jwolber/Documents/recipes_blog","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jwolber/Documents/recipes_blog/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jwolber/Documents/recipes_blog/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jwolber/Documents/recipes_blog/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jwolber/Documents/recipes_blog/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "nitro": {
    ...
    "routeRules": {
      ...
      "/__nuxt_content/posts/sql_dump.txt/_payload.json": {
        "prerender": true
      }
    }
  },
  "public": {
    "supabase": {
      "url": "https://nbyodpcqqmdwtcsmriis.supabase.co",
      "key": "sb_publishable_Ry53f227wAc3MEppsDU_5A_pbTgBUpn",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
      ...
      "cookieName": "sb",
      "cookiePrefix": "sb-nbyodpcqqmdwtcsmriis-auth-token",
      "useSsrCookies": true,
      "cookieOptions": {
        "maxAge": 28800,
        "sameSite": "lax",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/jwolber/Documents/recipes_blog/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  }
};
...
const _aRe1m1eVaJosu3xUVgSvQABD5dz7wLcRS_eqPn5MpU = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/jwolber/Documents/recipes_blog";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Curiosity is all you need. Personal blog on science, AI, programming, medicine, health and fitness. Doctoral student in Computational Biomedicine at RWTH Aachen."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Jonas Wolber — Science, AI, Programming, Medicine, Health & Fitness"};
...
const _Kfhp1qGA_ghiMnDd5UkUacTdqRPCvM2u04UeovlGJk = (nitroApp) => {
...
const plugins = [
  _aRe1m1eVaJosu3xUVgSvQABD5dz7wLcRS_eqPn5MpU,
_Kfhp1qGA_ghiMnDd5UkUacTdqRPCvM2u04UeovlGJk
];
...
const _XZ2UVo = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/jwolber/Documents/recipes_blog/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/jwolber/Documents/recipes_blog/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _Er9FIu = eventHandler(async (event) => {
  ...
  return await import('file:///Users/jwolber/Documents/recipes_blog/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _8cf53u = eventHandler(async (event) => {
...
const _lazy_ICuG8A = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _XZ2UVo, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_ICuG8A, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/posts/sql_dump.txt', handler: _Er9FIu, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/sql_dump.txt', handler: _Er9FIu, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/posts/query', handler: _8cf53u, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/info/query', handler: _8cf53u, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ICuG8A, lazy: true, middleware: false, method: undefined }
];
