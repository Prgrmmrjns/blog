...
export const localComponentLoaders = {
  BlogCard: () => import("./../../app/components/BlogCard.vue").then(m => pickExport(m, "default", "BlogCard", "./../../app/components/BlogCard.vue")),
  BlogComments: () => import("./../../app/components/BlogComments.vue").then(m => pickExport(m, "default", "BlogComments", "./../../app/components/BlogComments.vue")),
  IconArrowLeft: () => import("./../../app/components/IconArrowLeft.vue").then(m => pickExport(m, "default", "IconArrowLeft", "./../../app/components/IconArrowLeft.vue")),
  IconClock: () => import("./../../app/components/IconClock.vue").then(m => pickExport(m, "default", "IconClock", "./../../app/components/IconClock.vue")),
  IconFlame: () => import("./../../app/components/IconFlame.vue").then(m => pickExport(m, "default", "IconFlame", "./../../app/components/IconFlame.vue")),
  MetaPill: () => import("./../../app/components/MetaPill.vue").then(m => pickExport(m, "default", "MetaPill", "./../../app/components/MetaPill.vue")),
  Navbar: () => import("./../../app/components/Navbar.vue").then(m => pickExport(m, "default", "Navbar", "./../../app/components/Navbar.vue")),
...
export const localComponents: string[] = ["BlogCard","BlogComments","IconArrowLeft","IconClock","IconFlame","MetaPill","Navbar","NuxtWelcome","NuxtLayout","NuxtErrorBoundary","ClientOnly","DevOnly","ServerPlaceholder","NuxtLink","NuxtLoadingIndicator","NuxtTime","NuxtRouteAnnouncer","NuxtImg","NuxtPicture","ContentRenderer","NuxtPage","NoScript","Link","Base","Title","Meta","Style","Head","Html","Body","MDC","MDCCached","MDCRenderer","MDCSlot","NuxtIsland"]