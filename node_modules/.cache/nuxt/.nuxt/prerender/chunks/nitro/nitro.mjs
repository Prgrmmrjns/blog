import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getRouterParam, setHeader, getResponseStatus, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler } from 'file:///Users/jwolber/Documents/blog/node_modules/h3/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/jwolber/Documents/blog/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/jwolber/Documents/blog/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/jwolber/Documents/blog/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/jwolber/Documents/blog/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/jwolber/Documents/blog/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, defineDriver, prefixStorage } from 'file:///Users/jwolber/Documents/blog/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jwolber/Documents/blog/node_modules/unstorage/drivers/fs.mjs';
import crypto from 'node:crypto';
import fsDriver from 'file:///Users/jwolber/Documents/blog/node_modules/unstorage/drivers/fs-lite.mjs';
import lruCache from 'file:///Users/jwolber/Documents/blog/node_modules/unstorage/drivers/lru-cache.mjs';
import { digest } from 'file:///Users/jwolber/Documents/blog/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/jwolber/Documents/blog/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/jwolber/Documents/blog/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/jwolber/Documents/blog/node_modules/scule/dist/index.mjs';
...
import { dirname, resolve } from 'file:///Users/jwolber/Documents/blog/node_modules/pathe/dist/index.mjs';
import { isAbsolute } from 'file:///Users/jwolber/Documents/blog/node_modules/@nuxt/content/node_modules/pathe/dist/index.mjs';
import sqliteConnector from 'file:///Users/jwolber/Documents/blog/node_modules/db0/dist/connectors/node-sqlite.mjs';
...
const _47Users_47jwolber_47Documents_47blog_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js = defineDriver(
  /**
...
storage.mount('internal:nuxt:prerender', _47Users_47jwolber_47Documents_47blog_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/Users/jwolber/Documents/blog/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/Users/jwolber/Documents/blog/node_modules/.cache/nuxt/.nuxt/cache/nitro/prerender"}));
storage.mount('data', fsDriver({"driver":"fsLite","base":"./.data/kv"}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jwolber/Documents/blog","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jwolber/Documents/blog/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jwolber/Documents/blog/node_modules/.cache/nuxt/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jwolber/Documents/blog/node_modules/.cache/nuxt/.nuxt/cache"}));
...
const _lazy_0tf8EN = () => import('../_/renderer.mjs').then(function (n) { return n.r; });
