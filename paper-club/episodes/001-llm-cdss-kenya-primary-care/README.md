...
| License | CC BY 4.0 |
| Runtime | ~11–13 min |
| Status | Draft — blog not copied to `content/blog/` yet |

## Files

- [`blog.md`](blog.md) — Nuxt-ready post (English)
...
Open `slides.html`, go full screen, read `script.md`. Advance on each `## SLIDE n` heading.
